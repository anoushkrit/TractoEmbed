...
def load_batch_data():
    """load test data"""
    eval_state = 'test'
    _, test_dataset = load_datasets(eval_split=eval_state, args=args, test=True, logger=logger) # _ value is None
...
if __name__ == '__main__':
    ...
    # weight_prefix_lst = ['tract']
    weight_prefix_lst = ['tract']
    org_labels_lst = None
    org_predicted_lst = None
